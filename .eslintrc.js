module.exports = {
    ...
    globals: {
        HTMLElement: false,
        chrome: false // 比如插件使用api的时候chrome开头的eslint不报错
    },
    ...
    extends: ['plugin:vue/essential', '@vue/standard'], // 使用 standard 标准

    rules: {
        'space-before-function-paren': 0, // 强制在 function的左括号之前使用一致的空格
        'no-debugger': 'off', // 禁止在代码中使用 debugger
        quotes: ['error', 'single'], // 单引号
        semi: ['error', 'never'], // 代码需要以分号结尾
